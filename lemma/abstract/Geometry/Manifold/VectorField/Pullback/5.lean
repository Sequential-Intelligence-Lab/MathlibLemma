...
lemma VectorField.mpullback_add'
  ...
  -- Two vector fields are equal if they agree at every point.
  ext x
  -- At each point, use linearity of the underlying map and pointwise addition.
  simp [VectorField.mpullback, Pi.add_def, map_add]