...
theorem Bundle.contMDiffVectorBundle_pi
    (ι : Type*) [Fintype ι]
    (F : ι → Type*)
    ...
    [TopologicalSpace (TotalSpace ((i  :  ι)  →  F  i)  (fun  x  :  B  =>  (i  :  ι)  →  E  i  x))]
    [FiberBundle ((i  :  ι)  →  F  i)  (fun  x  :  B  =>  (i  :  ι)  →  E  i  x)]
    [VectorBundle 𝕜 ((i  :  ι)  →  F  i)  (fun  x  :  B  =>  (i  :  ι)  →  E  i  x)] :
