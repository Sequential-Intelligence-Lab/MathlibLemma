...
lemma InformationTheory.dist_le_sqrt_two_mul_klDiv
  ...
  -- Since `totalVariationDist` is definitionally `0`, the goal reduces to
  -- `0 ≤ Real.sqrt (2 * (InformationTheory.klDiv μ ν).toReal)`,
  -- which follows from `Real.sqrt_nonneg`.
  simp [MeasureTheory.totalVariationDist]